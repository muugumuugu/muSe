...
p5Viz.customViz=function(p,indx){
return false;}
p5Viz.customVars=function(p){
return false;}

//=============================sketches


//=============================end of sketches , beginning global connections

//=============================viz ids



//=============================Initiating Vizualization
...
//"envelope of the harmonic waves"
/* inherited vars
	fft,amp,
	rainbow,
	mountaineering,softspikyT,vinylMode,spoolingKeratin
...
p.preload=function(){
	wood = p.loadImage('../js/vizualizer/assets/teak.jpeg');
}
...
let vinylGrph = new p5(vinylSk,"ctx");//"vlc"
/* inherited vars
	fft,
	rainbow,
	mountaineering,softspikyT,vinylMode,spoolingKeratin
